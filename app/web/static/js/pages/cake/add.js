jQuery(function($) {
    console.log('Cake add.js loaded');
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="input-group">
                            <input type="number" class="form-control" name="price[]" min="0" step="1000" placeholder="Giá" required>
    ...
    $('#addCakeForm').submit(function(e) {
        ...
        // Gửi form data
        console.log('Sending AJAX request to /cake/add-file');
        $.ajax({
            url: '/cake/add-file',
            type: 'POST',
            data: formData,
